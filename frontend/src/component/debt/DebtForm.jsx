                        ...
                        <div className="col-md-4">
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    {(values.installmentType === '1' || values.installmentType === '') && (<div className="week">
                                    ...
                                    {values.installmentType === '2' && (<div className="date">
                                    ...
                                    {values.installmentType === '3' && (<div className="">
