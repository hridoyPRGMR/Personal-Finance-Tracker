...
public class Debt {
	...
	public Debt(byte debtType, String creditor, Double outstandingBalance, LocalDate borrowingDate, byte loanTenure,
			Double interestRate, byte intrestType, byte installmentType, byte day, byte date, byte month,
	...
	public byte getIntrestType() {
		return intrestType;
	}

	public void setIntrestType(byte intrestType) {
		this.intrestType = intrestType;
	}
